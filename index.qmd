...
#..............................plot..............................
ggplot(q16_median, aes(x = fct_reorder(median, desc(n)), y = n, label = perc_label)) +
  geom_col(fill = "#047C91") +
  geom_text(position = position_stack(vjust = 0.5), size = 3, color = "white", family = "nunito") +
...
#..............................plot..............................
ggplot(q16_mode, aes(x = fct_reorder(mode, desc(n)), y = n, label = perc_label)) +
  geom_col(fill = "#047C91") +
  geom_text(position = position_stack(vjust = 0.5), size = 3, color = "white", family = "nunito") +
  labs(y = "Number of MEDS students", x = "Selection",
...
::: {.callout-note}
## All students continued on to answer question 19b
...
ggplot(q19b_writing_fxns, aes(x = writing_functions, y = n, label = perc_label)) +
  ...
  coord_flip() +
  geom_text(position = position_stack(vjust = 0.5), size = 3, color = "white", family = "nunito") +
  labs(y = "Number of MEDS students", x = "Comfortability level",
...
**`r q19b_not1` / `r q19b_num_answers` student respondents (`r ((q19b_not1/q19b_num_answers)*100)`%)** chose a comfortability level of 2 or greater, and therefore were directed to part c of question 19.
:::
...
#..............................plot..............................
ggplot(q19c_fxn_output, aes(x = fxn_output, y = n, label = perc_label)) +
  geom_col(fill = "#047C91") +
  geom_text(position = position_stack(vjust = 0.5), size = 3, color = "white", family = "nunito") +
  labs(y = "Number of MEDS students", x = "Selection",
...
#..............................plot..............................
ggplot(q20c_param_int, aes(x = fct_reorder(param_interactions, desc(n)), y = n, label = perc_label)) +
  geom_col(fill = "#047C91") +
  geom_text(position = position_stack(vjust = 0.5), size = 3, color = "white", family = "nunito") +
  labs(y = "Number of MEDS students", x = "Selection",
...
ggplot(q21b_rep_spatial, aes(x = fct_reorder(rep_spatial_data, desc(n)), y = n, label = perc_label, fill = rep_spatial_data)) +
  ...
  geom_text(position = position_stack(vjust = 0.5), size = 3, color = "white", family = "nunito") +
  labs(y = "Number of MEDS students", x = "Selection",
       title = "What are the two primary ways of representing spatial data (select two)?",
       caption = "Question 21b") +
  scale_fill_manual(values = pal, limits = names(pal)) +
  meds_theme
```
...
::: {.callout-note}
## One respondent did not answer all parts of Question 23
**`r q23a_not1` / `r q23a_num_answers` student respondents (`r ((q23a_not1/q23a_num_answers)*100)`%)** chose a familiarity level of 2 or greater -- these respondents were directed to answer all parts of question 23. One respondent selected **1 (never worked with it before)** in response to Question 23a and was jumped directly to Question 24.
:::
...
::: {.callout-note}
## Two respondents did not answer all parts of Question 23
**`r q24a_not1` / `r q24a_num_answers` student respondents (`r ((q24a_not1/q24a_num_answers)*100)`%)** chose a familiarity level of 2 or greater -- these respondents were directed to answer Question 23b. Two respondents selected **1 (never heard of it)** in response to Question 24a and were jumped directly to Question 25.
:::
...
::: {.callout-note}
## All respondents continued on to Question 25b
...
::: {.callout-note}
## All respondents continued on to Question 25c
...
::: {.callout-note}
## All respondents continued on to Question 26b
...
::: {.callout-note}
## All respondents continued on to Question 26c

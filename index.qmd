...
**`r q17_num_answers` / 29 student respondents (`r ((q17_num_answers/29)*100)`%)** chose a familiarity level of 2 or greater, and therefore were directed to answer all parts of question 17.
:::
...
**`r q18a_num_answers` / 29 student respondents (`r ((q18a_num_answers/29)*100)`%)** chose a familiarity level of 2 or greater, and therefore were directed to answer all parts of question 18.
:::
...
**`r q19_num_answers` / 29 student respondents (`r ((q19_num_answers/29)*100)`%)** chose a familiarity level of 2 or greater, and therefore were directed to answer all parts of question 19.
:::
...
**`r q21a_num_answers` / 29 student respondents (`r ((q21a_num_answers/29)*100)`%)** chose a familiarity level of 2 or greater, and therefore were directed to answer all parts of question 21.
:::

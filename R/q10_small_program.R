...
# clean_q10_small_program_bothPP <- function(PLO_data_clean){
#   
#   #........................to iterate over.........................
...
#   select(small_program, timepoint) |> 
#     
#     # sum ----
#   group_by(timepoint, small_program) |> 
#     count() |> 
#     ungroup() 
#   
#   ##~~~~~~~~~~~~~~~~~~
...
#       new_row <- data.frame(timepoint = "Pre-MEDS", small_program = cat_name, n = 0)
...
#       
#       message(cat_name, " does not exist. Adding now.")
#       new_row <- data.frame(timepoint = "Post-MEDS", small_program = cat_name, n = 0)

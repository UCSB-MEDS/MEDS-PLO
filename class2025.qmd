...
#..........................import data...........................
meds2025_before <- read_sheet("https://docs.google.com/spreadsheets/d/1E3WbMZuOl33sUgbJcPmrqMQbCp3-AsmRAjuxdNXk6oM/edit?gid=1486409728#gid=1486409728")
#meds2025_after <- read_sheet("https://docs.google.com/spreadsheets/d/1qBGprUADckBLDlSFOx2LjlF4ZbH_qvvq18BCGLciFl4/edit?usp=sharing")
  
#...........................clean data...........................
meds2025_before_clean <- clean_PLO_data(meds2025_before) |> mutate(timepoint = rep("Pre-MEDS"))
#meds2025_after_clean <- clean_PLO_data(meds2025_after) |> mutate(timepoint = rep("Post-MEDS"))

#...............combine pre- and post-MEDS results...............
# both_timepoints_clean <- rbind(meds2025_before_clean, meds2025_after_clean) |> 
#   mutate(timepoint = fct_relevel(timepoint, c("Pre-MEDS", "Post-MEDS")))

#..................number of survey respondents..................=
pre_meds_num_respondents <- nrow(meds2025_before_clean)
#post_meds_num_respondents <- nrow(meds2025_after_clean)
...
{{< include /sections/class2025/summary.qmd >}}
...
#..........................combined plot.........................
ggplot(meds2025_before_clean, aes(x = sc0)) +
...
q1_os_data <- clean_q1_os(meds2025_before_clean)
...
# wrangle & plot ----
q2_store_data <- clean_q2_store_data(meds2025_before_clean)
...
q3_gui_data <- #clean_freq_rank_data(all_PLO_data = both_timepoints_clean, 
                clean_freq_rank_data(all_PLO_data = meds2025_before_clean,
...
# wrangle ----
q4_prog_lang_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean, 
...
# wrangle ----
q5_databases_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean, 
                                          col_name = "databases",
                                          categories = c("Never", 
                                                         "Less than once per year", 
                                                         "Several times per year", 
...
# wrangle ----
q6_version_control_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean, 
...
# wrangle ----
q7_command_shell_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean, 
...
# wrangle ----
q8_workflow_satisfaction_data <- clean_q8_workflow_sat(meds2025_before_clean)# both_timepoints_clean)
...
# wrangle ----
q9_raw_data_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean,#both_timepoints_clean,
                                         col_name = "raw_data",
...
# wrangle ----
q10_small_program_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
# wrangle ----
q11_find_help_online_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
# wrangle ----
q12_overcoming_problems_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
# wrangle ----
q13_confidence_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
# wrangle ----
q14_easier_analysis_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
# wrangle ----
q15_increase_efficiency_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
#| include: false
#| eval: false
one_respondent <- meds2025_after_clean |> 
...
# wrangle ----
q16a_median_data <- clean_q16a_median(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q16b_mode_data <- clean_q16b_mode(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q17a_familiarity_lr_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
{{< include /sections/class2025/q17-callout-inline-code.qmd >}}
...
# wrangle ----
q17b_microplastics_data <- clean_q17b_microplastics(meds2025_before_clean)#both_timepoints_clean)
...
#~..........................wrangle.............................
q17_microplastics_dt <- meds2025_before_clean |> 
...
#~..........................wrangle.............................
q17_microplastics_dt <- meds2025_after_clean |>
...
# wrangle ----
q18a_familiar_prob_dist_data <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
                                                     col_name = "prob_dist",
                                                     categories = c("1 (never heard of it)", 
                                                                    "2",
                                                                    "3 (vague sense of what it means)",
...
{{< include /sections/class2025/q18-callout-inline-code.qmd >}}
...
q18b_prob_dist_terms_data <- clean_q18b_prob_dist_terms(meds2025_before_clean) #both_timepoints_clean)
...
q18b_prob_dist_FULLY_CORRECT_data <- clean_q18b_FULLY_CORRECT(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q19a_familiar_functions_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
{{< include /sections/class2025/q19b-callout-inline-code.qmd >}}
...
# wrangle ----
q19b_writing_functions_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
{{< include /sections/class2025/q19c-callout-inline-code.qmd >}}
...
# wrangle ----
q19c_fxn_output_data <- clean_q19c_fxn_output(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q20a_run_env_mod_data <- clean_q20a_run_env_mod(meds2025_before_clean)#both_timepoints_clean)

# plot ----
plot_q20a_run_env_mod(q20a_run_env_mod_data)
```

{{< include /sections/class2025/q20a-callout-inline-code.qmd >}}
...
# wrangle ----
q20b_sa_data <- clean_q20b_sa(meds2025_before_clean)#both_timepoints_clean)

# plot ----
plot_q20b_sa(q20b_sa_data)
```

{{< include /sections/class2025/q20b-callout-inline-code.qmd >}}
...
# wrangle ----
q20c_param_int_data <- clean_q20c_param_int(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q21a_comfort_spatial_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
{{< include /sections/class2025/q21-callout-inline-code.qmd >}}

```{r}
# wrangle (INDIV RESPONSES) ----
q21b_rep_spatial_data <- clean_q21b_rep_spatial(meds2025_before_clean)#both_timepoints_clean)
...
```{r}
# wrangle (FULLY CORRECT) ----
q21b_FULLY_CORRECT_data <- clean_q21b_FULLY_CORRECT(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q21c_vec_ras_data <- clean_q21c_vec_ras(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q22a_comfort_rs_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
{{< include /sections/class2025/q22-callout-inline-code.qmd >}}
...
# wrangle ----
q22b_rs_sun_data <- clean_q22b_rs_sun(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q23a_comfort_map_proj_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
{{< include /sections/class2025/q23-callout-inline-code.qmd >}}
...
# wrangle ----
q23b_reproj_data <- clean_q23b_reproj(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q24a_familiarity_rs_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
{{< include /sections/class2025/q24-callout-inline-code.qmd >}}
...
# wrangle ----
q24b_veg_wave_data <- clean_q24b_veg_wave(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q25a_familiar_ml_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
{{< include /sections/class2025/q25a-callout-inline-code.qmd >}}
...
# wrangle ----
q25b_unsup_alg_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
{{< include /sections/class2025/q25b-callout-inline-code.qmd >}}
...
# wrangle ----
q25c_kmeans_data <- clean_q25c_kmeans(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q26a_div_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean,#both_timepoints_clean,
...
{{< include /sections/class2025/q26a-callout-inline-code.qmd >}}
...
# wrangle ----
q26b_tvs_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
{{< include /sections/class2025/q26b-callout-inline-code.qmd >}}

```{r}
# wrangle (INDIV RESPONSES) ----
q26c_mod_perf_data <- clean_q26c_mod_perf(meds2025_before_clean)#both_timepoints_clean)
...
```{r}
# wrangle (FULLY CORRECT) ----
q26c_FULLY_CORRECT_data <- clean_q26c_FULLY_CORRECT(meds2025_before_clean)#both_timepoints_clean)
...
# wrangle ----
q27_data_justice_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
# wrangle ----
q28_bias_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
                                       col_name = "bias",
                                       categories = c("1 (strongly disagree)",
                                                      "2", 
                                                      "3 (neutral)",
...
# wrangle ----
q29_create_viz_data  <- clean_freq_rank_data(all_PLO_data = meds2025_before_clean, #both_timepoints_clean,
...
# wrangle ----
q30_improve_dv_pre <- clean_q30_improve_dv(meds2025_before_clean)
...
# wrangle ----
q30_improve_dv_post <- clean_q30_improve_dv(meds2025_after_clean)
...
#~..........................wrangle.............................
q30_improve_dv_pre <- meds2025_before_clean |> 
...
#~..........................wrangle.............................
q30_improve_dv_post <- meds2025_after_clean |> 
...
# wrangle ----
q31_lang_data <- clean_q31_lang(meds2025_before_clean)#both_timepoints_clean)

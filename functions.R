...
source("R/q21_spatial_data.R")
source("R/q22_remote_sensing.R")
source("R/q23_map_projections.R")
source("R/q24_reflectance.R")
source("R/q25_ML.R")
source("R/q26_TrainValidSplit.R")
source("R/q27_data_justice.R")
source("R/q28_bias.R")

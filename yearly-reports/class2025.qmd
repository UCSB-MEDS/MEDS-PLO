...
author: "Sam Shanny-Csik & Jamie Montgomery"
date: August 13, 2024
...
meds2025_after <- read_sheet("https://docs.google.com/spreadsheets/d/1sEetdIXKXQNhVShJHddZd2tnS1QP5-uw0Sk8x3qd7Is/edit?usp=sharing")
...
# wrangle ----
q17a_familiarity_lr_data <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
#~..........................wrangle.............................
q17_microplastics_dt <- both_timepoints_clean |> 
...
# wrangle ----
q18a_familiar_prob_dist_data <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
                                                     col_name = "prob_dist",
                                                     categories = c("1 (never heard of it)", 
                                                                    "2",
                                                                    "3 (vague sense of what it means)",
...
# wrangle ----
q19a_familiar_functions_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q19b_writing_functions_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q21a_comfort_spatial_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q22a_comfort_rs_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q23a_comfort_map_proj_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q24a_familiarity_rs_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q25a_familiar_ml_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q25b_unsup_alg_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q26a_div_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q26b_tvs_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q27_data_justice_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
# wrangle ----
q28_bias_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
                                       col_name = "bias",
                                       categories = c("1 (strongly disagree)",
                                                      "2", 
                                                      "3 (neutral)",
...
# wrangle ----
q29_create_viz_data  <- clean_freq_rank_data(all_PLO_data = both_timepoints_clean,
...
```{r}
#~..........................wrangle.............................
q30_improve_dv_pre <- both_timepoints_clean |> 

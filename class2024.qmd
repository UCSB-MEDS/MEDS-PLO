...
q1_os_data <- clean_q1_os_bothPP(both_timepoints_clean)
plot_q1_os_bothPP(q1_os_data)
```
...
# wrangle & plot ----
q2_store_data <- clean_q2_store_data_bothPP(both_timepoints_clean)
plot_q2_store_data_bothPP(q2_store_data)
```
...
# wrangle ----
q3_gui_data <- clean_q3_gui_bothPP(both_timepoints_clean)

# plot ----
plot_frequency_use_bothPP(data = q3_gui_data,
...
# wrangle ----
q4_prog_lang_data <- clean_q4_prog_lang_bothPP(both_timepoints_clean)

# plot ----
plot_frequency_use_bothPP(data = q4_prog_lang_data,
...
# wrangle ----
q5_databases_data <- clean_q5_databases_bothPP(both_timepoints_clean)

# plot ----
plot_frequency_use_bothPP(data = q5_databases_data, 
...
q6_version_control_data <- clean_q6_version_control_bothPP(PLO_data_clean = both_timepoints_clean)

# plot ----
plot_frequency_use_bothPP(data = q6_version_control_data,
...
# wrangle ----
q7_command_shell_data <- clean_q7_command_shell_bothPP(both_timepoints_clean)

# plot ----
plot_frequency_use_bothPP(data = q7_command_shell_data,
...
# wrangle ----
q8_workflow_satisfaction_data <- clean_q8_workflow_satisfaction_bothPP(both_timepoints_clean)

# plot ----
plot_q8_workflow_satisfaction_bothPP(q8_workflow_satisfaction_data)
```
...
# wrangle ----
q9_raw_data_data <- clean_q9_raw_data_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q9_raw_data_data,
...
# wrangle ----
q10_small_program_data <- clean_q10_small_program_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q10_small_program_data,
...
# wrangle ----
q11_find_help_online_data <- clean_q11_find_help_online_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q11_find_help_online_data ,
...
# wrangle ----
q12_overcoming_problems_data <- clean_q12_overcoming_problems_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q12_overcoming_problems_data,
...
# wrangle ----
q13_confidence_data <- clean_q13_confidence_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q13_confidence_data,
...
# wrangle ----
q14_easier_analysis_data <- clean_q14_easier_analysis_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q14_easier_analysis_data,
...
# wrangle ----
q15_increase_efficiency_data <- clean_q15_increase_efficiency_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q15_increase_efficiency_data,
...
# wrangle ----
q16a_median_data <- clean_q16a_median_bothPP(both_timepoints_clean)

# plot ----
plot_q16a_median_bothPP(q16a_median_data)
```
...
# wrangle ----
q16b_mode_data <- clean_q16b_mode_bothPP(both_timepoints_clean)

# plot ----
plot_q16b_mode_bothPP(q16b_mode_data)
```
...
# wrangle ----
q17a_familiarity_lr_data <- clean_q17a_familiar_lr_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q17a_familiarity_lr_data,
...
# wrangle ----
q17b_microplastics_data <- clean_q17b_microplastics_bothPP(both_timepoints_clean)

# plot ----
plot_q17b_microplastics_bothPP(q17b_microplastics_data) 
```
...
# wrangle ----
q18a_familiar_prob_dist_data <- clean_q18a_familiar_prob_dist_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q18a_familiar_prob_dist_data,
...
q18b_prob_dist_terms_data <- clean_q18b_prob_dist_terms_bothPP(both_timepoints_clean)

# plot (INDIV RESPONSES) ----
plot_q18b_prob_dist_terms_bothPP(q18b_prob_dist_terms_data)
```
...
q18b_prob_dist_FULLY_CORRECT_data <- clean_q18b_FULLY_CORRECT_bothPP(both_timepoints_clean)

# plot (FULLY CORRECT) ----
plot_q18b_FULLY_CORRECT_bothPP(q18b_prob_dist_FULLY_CORRECT_data)
```
:::
...
# wrangle ----
q19a_familiar_functions_data <- clean_q19a_familiar_functions_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q19a_familiar_functions_data,
...
# wrangle ----
q19b_writing_functions_data <- clean_q19b_writing_functions_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q19b_writing_functions_data,
...
# wrangle ----
q19c_fxn_output_data <- clean_q19c_fxn_output_bothPP(both_timepoints_clean)

# plot ----
plot_q19c_fxn_output_bothPP(q19c_fxn_output_data)
```
...
# wrangle ----
q20a_run_env_mod_data <- clean_q20a_run_env_mod_bothPP(both_timepoints_clean)

# plot ----
plot_q20a_run_env_mod_bothPP(q20a_run_env_mod_data)
```
...
# wrangle ----
q20b_sa_data <- clean_q20b_sa_bothPP(both_timepoints_clean)

# plot ----
plot_q20b_sa_bothPP(q20b_sa_data)
```
...
# wrangle ----
q20c_param_int_data <- clean_q20c_param_int_bothPP(both_timepoints_clean)

# plot ----
plot_q20c_param_int_bothPP(q20c_param_int_data)
```
...
# wrangle ----
q21a_comfort_spatial_data <- clean_q21a_comfort_spatial_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q21a_comfort_spatial_data,
...
```{r}
# wrangle (INDIV RESPONSES) ----
q21b_rep_spatial_data <- clean_q21b_rep_spatial_bothPP(both_timepoints_clean)

# plot (INDIV RESPONSES) ----
plot_q21b_rep_spatial_bothPP(q21b_rep_spatial_data)
```
...
```{r}
# wrangle (FULLY CORRECT) ----
q21b_FULLY_CORRECT_data <- clean_q21b_FULLY_CORRECT_bothPP(both_timepoints_clean)

# plot (FULLY CORRECT) ----
plot_q21b_FULLY_CORRECT_bothPP(q21b_FULLY_CORRECT_data)
```
:::
...
# wrangle ----
q21c_vec_ras_data <- clean_q21c_vec_ras_bothPP(both_timepoints_clean)

# plot ----
plot_q21c_vec_ras_bothPP(q21c_vec_ras_data)
```
...
# wrangle ----
q22a_comfort_rs_data <- clean_q22a_comfort_rs_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q22a_comfort_rs_data,
...
# wrangle ----
q22b_rs_sun_data <- clean_q22b_rs_sun_bothPP(both_timepoints_clean)

# plot ----
plot_q22b_rs_sun_bothPP(q22b_rs_sun_data)
```
...
# wrangle ----
q23a_comfort_map_proj_data <- clean_q23a_comfort_map_proj_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q23a_comfort_map_proj_data,
...
# wrangle ----
q23b_reproj_data <- clean_q23b_reproj_bothPP(both_timepoints_clean)

# plot ----
plot_q23b_reproj_bothPP(q23b_reproj_data)
```
...
# wrangle ----
q24a_familiarity_rs_data <- clean_q24a_familiarity_rs_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q24a_familiarity_rs_data,
...
# wrangle ----
q24b_veg_wave_data <- clean_q24b_veg_wave_bothPP(both_timepoints_clean)

# plot ----
plot_q24b_veg_wave_bothPP(q24b_veg_wave_data)
```
...
# wrangle ----
q25a_familiar_ml_data <- clean_q25a_familiar_ml_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q25a_familiar_ml_data,
...
# wrangle ----
q25b_unsup_alg_data <- clean_q25b_unsup_alg_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q25b_unsup_alg_data,
...
# wrangle ----
q25c_kmeans_data <- clean_q25c_kmeans_bothPP(both_timepoints_clean)

# plot ----
plot_q25c_kmeans_bothPP(q25c_kmeans_data)
```
...
# wrangle ----
q26a_div_data <- clean_q26a_div_data_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q26a_div_data,
...
# wrangle ----
q26b_tvs_data <- clean_q26b_tvs_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q26b_tvs_data,
...
```{r}
# wrangle (INDIV RESPONSES) ----
q26c_mod_perf_data <- clean_q26c_mod_perf_bothPP(both_timepoints_clean)

# plot (INDIV RESPONSES) ----
plot_q26c_mod_perf_bothPP(q26c_mod_perf_data)
```
...
```{r}
# wrangle (FULLY CORRECT) ----
q26c_FULLY_CORRECT_data <- clean_q26c_FULLY_CORRECT_bothPP(both_timepoints_clean)

# plot (FULLY CORRECT) ----
plot_q26c_FULLY_CORRECT_bothPP(q26c_FULLY_CORRECT_data)
```
:::
...
# wrangle ----
q27_data_justice_data <- clean_q27_data_justice_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q27_data_justice_data,
...
# wrangle ----
q28_bias_data <- clean_q28_bias_bothPP(both_timepoints_clean)

# plot ----
plot_rank_bothPP(data = q28_bias_data,
...
# wrangle ----
q29_create_viz_data <- clean_q29_create_viz_bothPP(both_timepoints_clean)
...
# wrangle ----
q31_lang_data <- clean_q31_lang_bothPP(both_timepoints_clean)

# plot ----
plot_q31_lang_bothPP(q31_lang_data)
```

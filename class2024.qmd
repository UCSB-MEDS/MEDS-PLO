...
#...........................clean data...........................
meds2024_before_clean <- clean_PLO_data(meds2024_before) |> mutate(timepoint = rep("before"))
meds2024_after_clean <- clean_PLO_data(meds2024_after) |> mutate(timepoint = rep("after"))
...
# ggplot(scores_before, aes(x = sc0)) +
#   geom_histogram(binwidth = 1, color = "white", fill = meds_pal["before"]) +
#   geom_vline(xintercept = median_score_before,  linetype = "dashed", color = "black") +
#   annotate(geom = "label", x = 9.8, y = 8, label = paste0("Median Score (before) = ", median_score_before), hjust = "right") +
...
# ggplot(scores_after, aes(x = sc0)) +
#   geom_histogram(binwidth = 1, color = "white", fill = meds_pal["after"]) +
#   geom_vline(xintercept = median_score_after,  linetype = "dashed", color = "black") +
#   annotate(geom = "label", x = 9.8, y = 8, label = paste0("Median Score (before) = ", median_score_after), hjust = "right") +
#   annotate(geom = "segment", x = 7, y = 8, xend = median_score_after, yend = 7.5,
#            arrow = arrow(length = unit(3, "mm"))) +
#   scale_x_continuous(breaks = seq(1, 14, 1)) +
#   labs(x = "Score", y = "Number of MEDS students",
#        title = "Distribution of scores",
...
#..................combine before & after data...................
all2024_scores <- rbind(meds2024_before_clean, meds2024_after_clean) |> 
  mutate(timepoint = fct_relevel(timepoint,
                                 c("before", "after")))

#..........................combined plot.........................
ggplot(all2024_scores, aes(x = sc0)) +
  ...
  #                                 family = "sanchez", size = 13),
  #     axis.title.y = element_text(margin = margin(t = 0, r = 15, b = 0, l = 0), 
  #                                 family = "sanchez", size = 13), 
  #     axis.text = element_text(family = "nunito", size = 10),
  #     plot.title = element_text(margin = margin(t = 5, r = 0, b = 15, l = 0), 
  #                               size = 15, family = "sanchez"),
  #     plot.subtitle = element_text(margin = margin(t = 5, r = 0, b = 15, l = 0), 
  #                                  size = 13, family = "sanchez"),
...
# ggplot() +
#   geom_histogram(data = scores_before, aes(x = sc0), binwidth = 1, color = "white", fill = meds_pal["before"], alpha = 0.8) +
#   geom_histogram(data = scores_after, aes(x = sc0), binwidth = 1, color = "white", fill = meds_pal["after"], alpha = 0.8) +
#   scale_x_continuous(breaks = seq(1, 14, 1)) +
...
q1_os_data <- clean_q1_os_bothPP(all2024_scores)

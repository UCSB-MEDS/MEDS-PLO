This PLO assessment was administered to the MEDS class of 2025 both [***before* beginning the program**]{.teal-text}, on August 2, 2024 **(response rate = `r nrow(meds2025_before_clean)`/29 students)**.
...
A perfect score is 14 points. **The median score was `r median_score_before`.** 

...
::: {.callout-note}
## `q20b_yes_post`/`q20b_total_answers_post` Post-MEDS respondents were directed to answer Question 20c, as compared to the `r q20b_yes_pre`/`r q20b_total_answers_pre` respondents in the Pre-MEDS PLO Assessment.
